...
CREATE SCHEMA HumanResources
  ...
  CREATE TABLE JobCandidate(
    ...
    Resume TEXT NULL, -- XML(HRResumeSchemaCollection)
...
CREATE SCHEMA Production
  ...
  CREATE TABLE ProductModel(
    ...
    Name "Name" NOT NULL,
    CatalogDescription TEXT NULL, -- XML(Production.ProductDescriptionSchemaCollection)
    Instructions TEXT NULL, -- XML(Production.ManuInstructionsSchemaCollection)
...
CREATE SCHEMA Sales
  ...
  CREATE TABLE Store(
    ...
    Name "Name" NOT NULL,
    SalesPersonID INT NULL,
    Demographics TEXT NULL, -- XML(Sales.StoreSurveySchemaCollection)
